 ...
 *
 * Batch 11B — Playtest Stabilization.
 * Contoh MPI lengkap: Cover → Tujuan → Pemantik → Materi → Quiz → Game → Refleksi → Penutup
 */
        ...
        components: [
          {
            ...
            type: 'text',
            text: 'Hidup Tertib dengan Norma',
            variant: 'title',
      ...
      // 2. Tujuan Pembelajaran
      {
        ...
        components: [
          ...
          },
          {
            id: createComponentId(),
            type: 'text',
            text: 'Setelah mempelajari materi ini, peserta didik diharapkan mampu:\n1. Menjelaskan pengertian norma dalam kehidupan sehari-hari\n2. Mengidentifikasi jenis-jenis norma yang berlaku di masyarakat\n3. Menunjukkan sikap tertib dalam menjalankan norma',
            variant: 'body',
            x: 80, y: 120, width: 1120, height: 300,
          },
        ],
      },
      // 3. Pemantik
        ...
        components: [
          {
            id: createComponentId(),
            type: 'text',
            text: 'Pernahkah kamu terlambat ke sekolah karena tidak patuh pada jam tidur?',
          ...
          },
          {
            ...
            title: 'Pikirkan!',
            body: 'Apa yang terjadi jika semua orang berlaku sesuka hati tanpa aturan?',
      ...
      // 4. Materi
      {
        ...
        components: [
          ...
          },
          {
            id: createComponentId(),
            type: 'text',
            text: 'Norma adalah aturan atau ketentuan yang berlaku di masyarakat untuk mengatur perilaku anggotanya. Norma bersifat mengikat dan menjadi pedoman dalam bertindak.',
            variant: 'body',
            x: 80, y: 120, width: 1120, height: 120,
          },
          {
            id: createComponentId(),
            type: 'card',
            variant: 'infoCard',
            title: 'Jenis-Jenis Norma',
            body: '1. Norma Agama — aturan dari Tuhan\n2. Norma Kesusilaan — aturan tentang budi pekerti\n3. Norma Kesopanan — aturan tentang tata krama\n4. Norma Hukum — aturan dari negara',
            x: 80, y: 280, width: 1120, height: 220,
          },
          {
            id: createComponentId(),
            type: 'navigation',
        ...
        components: [
          {
            ...
            title: 'Kuis Norma',
            prompt: 'Norma yang berasal dari Tuhan dan mengatur hubungan manusia dengan Tuhan disebut...',
            choices: [
            ...
            missions: [
              {
                ...
                choices: [
                  { id: createComponentId(), text: 'Kesopanan' },
                  { id: createComponentId(), text: 'Hukum' },
                  { id: createComponentId(), text: 'Agama' },
                ],
                correctChoiceIndex: 0,
              ...
              },
              {
                ...
                choices: [
                  { id: createComponentId(), text: 'Norma Agama saja' },
                  { id: createComponentId(), text: 'Norma Hukum saja' },
                  { id: createComponentId(), text: 'Semua norma (agama, kesusilaan, hukum)' },
                ],
              ...
              },
              {
                id: createComponentId(),
                title: 'Misi 3',
                prompt: 'Norma yang sanksinya paling tegas dan memaksa adalah...',
                choices: [
                  { id: createComponentId(), text: 'Norma Hukum' },
                  { id: createComponentId(), text: 'Norma Kesopanan' },
                  { id: createComponentId(), text: 'Norma Kesusilaan' },
                ...
                correctChoiceIndex: 0,
                feedbackCorrect: 'Benar! Norma hukum memiliki sanksi tegas dari negara.',
                feedbackWrong: 'Belum tepat. Norma hukum yang paling tegas sanksinya.',
                points: 15,
              },
            ],
          },
      ...
      // 8. Penutup
      {
        ...
        components: [
          ...
          },
          {
            id: createComponentId(),
            type: 'text',
            text: 'Mari kita hidup tertib dengan norma!',
            variant: 'subtitle',
