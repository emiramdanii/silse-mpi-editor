...
/* Page background classes — base positioning (required for ::before/::after).
   Fase 3b Commit 4: added position:relative + z-index helper (was drifted —
   styles.css had position:relative, export had --silse-shadow-feel dead code).
   Dead --silse-shadow-feel / --silse-radius-feel custom props removed (YAGNI). */
.silse-bg-page-clean { position:relative; }
.silse-bg-page-clean > * { position:relative; z-index:1; }
.silse-bg-page-soft { position:relative; }
.silse-bg-page-soft > * { position:relative; z-index:1; }
.silse-bg-page-mission { position:relative; }
.silse-bg-page-mission > * { position:relative; z-index:1; }

/* Page background ::before — gradient overlay on canvas-frame */
