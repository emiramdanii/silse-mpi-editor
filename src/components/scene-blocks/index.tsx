...
export function useCustomStyleFromContext(): CustomStyleMap | undefined {
...
export function ActionButtonBlock({ contract, label, onClick, variant = 'primary', className = '', customStyle }: BlockProps & {
  ...
  // HOVER-STYLE-01: customStyle.buttonHover — AI can override hover state
  const buttonHoverStyle = safeStyle?.buttonHover as CSSProperties | undefined;
  return (
    <button
      ...
      onMouseEnter={buttonHoverStyle ? (e) => {
        Object.assign(e.currentTarget.style, buttonHoverStyle);
      } : undefined}
      onMouseLeave={buttonHoverStyle ? (e) => {
        // Restore original styles (re-apply base style)
